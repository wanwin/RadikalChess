...
public class ProposeMoveAttack {
    ...
    public static ProposeMoveAttack getInstance() {
        if (instance == null) {
            instance = new ProposeMoveAttack();
        }
        return instance;
    }
    ...
    public boolean selectMoveAttack(ChessPiece chessPiece, Movement movement, ChessBoard chessBoard) {
        if (chessPiece instanceof Pawn) {
            return attackPawn(chessPiece, movement, chessBoard);
        }
        if (chessPiece instanceof Rook) {
            return attackRook(chessPiece, movement, chessBoard);
        }
        if (chessPiece instanceof Bishop) {
            return attackBishop(chessPiece, movement, chessBoard);
        }
        if (chessPiece instanceof Queen) {
            return attackQueen(chessPiece, movement, chessBoard);
        }
        if (chessPiece instanceof King) {
            return attackKing(chessPiece, movement, chessBoard);
        }
        return false;
    }
    ...
    private boolean attackKing(ChessPiece chessPiece, Movement movement, ChessBoard chessBoard) {
        if (chessBoard.getCell()[movement.getDestination().getRow()][movement.getDestination().getColumn()].getChessPiece() != null
                && chessBoard.getCell()[movement.getDestination().getRow()][movement.getDestination().getColumn()].getChessPiece().getColour()
        ...
        if (movement.getOrigin().getColumn() - movement.getDestination().getColumn() > 0
            ...
            for (int i = movement.getOrigin().getColumn() - 1; i >= movement.getDestination().getColumn(); i--) {
                if (i > movement.getDestination().getColumn()
                        && chessBoard.getCell()[movement.getDestination().getRow()][i].getChessPiece() != null) {
                    return false;
                }
                else if (i == movement.getDestination().getColumn()
                        && chessBoard.getCell()[movement.getDestination().getRow()][i].getChessPiece() != null
                        && chessBoard.getCell()[movement.getDestination().getRow()][i].getChessPiece().getColour() != chessPiece.getColour()) {
                    return true;
                }
            }
            return false;
    ...
    private boolean moveVerticalAttack(ChessPiece chessPiece, Movement movement, ChessBoard chessBoard) {
        if (movement.getOrigin().getRow() - movement.getDestination().getRow() > 0
            ...
            for (int i = movement.getOrigin().getRow() - 1; i >= movement.getDestination().getRow(); i--) {
                if (i > movement.getDestination().getRow() && chessBoard.getCell()[i][movement.getDestination().getColumn()].getChessPiece() != null) {
                    return false;
                }
                else if (i == movement.getDestination().getRow() && chessBoard.getCell()[i][movement.getDestination().getColumn()].getChessPiece() != null
                        && chessBoard.getCell()[i][movement.getDestination().getColumn()].getChessPiece().getColour()
                        != chessPiece.getColour()) {
                    return true;
                }
            }
            return false;
        ...
        if (Math.abs(movement.getOrigin().getRow() - movement.getDestination().getRow())
            ...
            for (int i = 1; i < movement.getDestination().getColumn() - movement.getOrigin().getColumn() + 1; i++) {
                if (i < movement.getDestination().getColumn() - movement.getOrigin().getColumn()
                        && chessBoard.getCell()[movement.getOrigin().getRow() + i][movement.getOrigin().getColumn() + i].getChessPiece() != null) {
                    return false;
                }
